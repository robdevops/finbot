...
def process_request(service, chat_id, user, message, botName, userRealName, message_id):
	...
	#		typing.stop()
		...
		payload = [heading, webhook.strike("28 July 2025", service), webhook.strike("28 October 2025", service), webhook.strike("28 January 2026", service), "28 April 2026", "01 July 2026 commence payday super"]
		webhook.payload_wrapper(service, url, payload, chat_id)
	elif m_who:
