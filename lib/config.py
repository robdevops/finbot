...
config_demote_leveraged = os.getenv("demote_leveraged", 'True').lower() in ('true', '1', 't')
...
config_performance_use_sharesight = os.getenv('performance_use_sharesight', 'False').lower() in ('true', '1', 't')
config_print_headers = os.getenv('print_headers', 'False') in ('true', '1', 't')
